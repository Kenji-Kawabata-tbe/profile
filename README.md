...
- 新機能検討
  - ビジネスメンバーと今後必要な機能を適宜検討
    - QRコードで効果計測、デモグラフィック情報に応じた最適化配信、広告の自動作成のような案のみのものも含め
#### 発揮したバリュー
- システム更新に伴いシステムコストをほぼ半減化
- 各種自動化に伴い開発生産性向上に貢献。また情報共有も適宜行い、担当領域/技術スタックが異なるメンバーにもリリース作業やAWSリソースの修正を実施できるよう貢献。
...
#### 発揮したバリュー
- 時にはクライアントと対面でのコミュニケーションを行いながらクライアントが求めているものを非エンジニアメンバーと検討。案件受注に繋がり会社の売上に直接貢献。
...
#### 発揮したバリュー
- チーム入れ替わりにより引き継ぎが十分に行われずブラックボックス化していた業務のキャッチアップ。体系化しツールを用いて適宜自動化することで作業時間の短縮、ヒューマンエラーの減少を実現

### 教育系アプリのシステム構築、運用/保守(2019年4月〜2020年2月)
#### 担当業務
- 新システムの環境構築、各種自動化、監視設定、エラー調査、費用計算、負荷テスト
#### チーム規模
